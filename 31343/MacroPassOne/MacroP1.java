...
public class MacroP1 {
	...
	public static void main(String[] args) throws IOException{
		...
		Scanner input = new Scanner(new File("mnt.txt"));
		...
		input = new Scanner(new File("mdt.txt"));
		...
		input = new Scanner(new File("pntab.txt"));
		...
		input = new Scanner(new File("kpdt.txt"));
		...
		input = new Scanner(new File("intermediate.txt"));
